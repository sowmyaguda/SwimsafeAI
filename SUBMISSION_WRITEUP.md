...
## HITL Flow
If a pool has dangerous chemical settings, PoolSense halts the report generation and prompts:
...
PoolSense increases public health awareness, prevents waterborne illnesses/skin flares, and automates pool chemistry diagnostics. It helps home pool owners keep their water balanced and keeps shared-pool managers alert to safety concerns.
